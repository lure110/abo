...
class Airi_Layout {
    ...
    public function body_classes( $classes ) {
        ...
        if (class_exists('LAHB', false) && Airi()->settings()->get('enable_header_builder', 'no') == 'yes') {
            $data = false;
    ...
    public function get_header_layout(){
        $layout = Airi()->settings()->get_setting_by_context('header_layout', 1);
    ...
    public function render_header_tpl(){
        ...
        if (class_exists('LAHB', false) && ( Airi()->settings()->get('enable_header_builder', 'no') == 'yes' ||  ( isset($_GET['lastudio_header_builder']) && $_GET['lastudio_header_builder'] == 'inline_mode' ) ) ) {
            get_template_part('templates/headers/header-builder' );
        }
        else{
