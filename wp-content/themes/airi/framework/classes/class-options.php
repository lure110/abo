...
class Airi_Options {
    ...
    public static function get_config_footer_layout_opts( $image_select = true, $inherit = false ){
        $options =  array(
            ...
            '4col4223'      => $image_select ? esc_url( Airi::$template_dir_url . '/assets/images/theme_options/footer-4cols-4-2-2-3.png')    : esc_attr_x('Footer 4 columns (4-2-2-3)', 'admin-view', 'airi'),
