...
$current_context = Airi()->get_current_context();


$page_title_bar_func = 'get';
if(Airi()->settings()->get_setting_by_context('page_title_bar_style', 'no') == 'yes'){
    $page_title_bar_func = 'get_setting_by_context';
}

$page_title_font_size = Airi()->settings()->get_setting_by_context('page_title_font_size', Airi()->settings()->get('page_title_font_size'));

if ( in_array('is_product', $current_context) ){
    if( 'on' == Airi()->settings()->get('single_product_override_page_title_bar', 'off') ) {
        $page_title_bar_func = 'get_setting_by_context';
    }
}
elseif ( in_array('is_single_la_portfolio', $current_context) ){
    if( 'on' == Airi()->settings()->get('single_portfolio_override_page_title_bar', 'off') ) {
        $page_title_bar_func = 'get_setting_by_context';
    }
}
elseif ( is_singular('post') ){
    if( 'on' == Airi()->settings()->get('single_post_override_page_title_bar', 'off') ) {
        $page_title_bar_func = 'get_setting_by_context';
    }
}
elseif ( in_array('is_shop', $current_context) || in_array('is_product_taxonomy', $current_context) ) {
    if( 'on' == Airi()->settings()->get('woo_override_page_title_bar', 'off') ) {
        $page_title_bar_func = 'get_setting_by_context';
    }
}
elseif ( in_array('is_archive_la_portfolio', $current_context) || in_array('is_tax_la_portfolio', $current_context) ) {
    if( 'on' == Airi()->settings()->get('archive_portfolio_override_page_title_bar', 'off') ) {
        $page_title_bar_func = 'get_setting_by_context';
    }
}


$page_title_bar_bg = Airi()->settings()->$page_title_bar_func('page_title_bar_background');
$page_title_bar_heading_color = Airi()->settings()->$page_title_bar_func('page_title_bar_heading_color', '#252634');
$page_title_bar_text_color = Airi()->settings()->$page_title_bar_func('page_title_bar_text_color', '#8a8a8a');
$page_title_bar_link_color = Airi()->settings()->$page_title_bar_func('page_title_bar_link_color', '#8a8a8a');
$page_title_bar_link_hover_color = Airi()->settings()->$page_title_bar_func('page_title_bar_link_hover_color', '#343538');
$page_title_bar_spacing = Airi()->settings()->$page_title_bar_func('page_title_bar_spacing');
$page_title_bar_spacing_desktop_small = Airi()->settings()->$page_title_bar_func('page_title_bar_spacing_desktop_small');
$page_title_bar_spacing_tablet = Airi()->settings()->$page_title_bar_func('page_title_bar_spacing_tablet');
$page_title_bar_spacing_mobile = Airi()->settings()->$page_title_bar_func('page_title_bar_spacing_mobile');
...
.section-page-header{
    ...
    <?php Airi_Helper::render_background_atts($page_title_bar_bg);?>
}
...
<?php
$main_space = Airi()->settings()->get_setting_by_context('main_space');
...
switch ($font_source) {
    case '1':
    $_s_main_font = (array) Airi()->settings()->get('main_font');
    $_s_secondary_font = (array) Airi()->settings()->get('secondary_font');
    $_s_highlight_font = (array) Airi()->settings()->get('highlight_font');
    ...
    case '2':
    $body_font_family = Airi()->settings()->get('main_google_font_face');
    $heading_font_family = Airi()->settings()->get('secondary_google_font_face');
    $highlight_font_family = Airi()->settings()->get('highlight_google_font_face');
    break;

    case '3':
    $body_font_family = Airi()->settings()->get('main_typekit_font_face');
    $heading_font_family = Airi()->settings()->get('secondary_typekit_font_face');
    $highlight_font_family = Airi()->settings()->get('highlight_typekit_font_face');
    break;
}
...
$body_background = shortcode_atts(array(
    ...
    'size' => '',
    'color' => '#fff'
), Airi()->settings()->get('body_background'));
...
$header_background = shortcode_atts(array(
    ...
    'size' => '',
    'color' => '#fff'
), Airi()->settings()->get('header_background'));
...
$transparency_header_background = shortcode_atts(array(
    ...
    'size' => '',
    'color' => 'rgba(0,0,0,0)'
), Airi()->settings()->get('transparency_header_background'));
...
$footer_background = shortcode_atts(array(
    ...
    'size' => '',
    'color' => '#fff'
), Airi()->settings()->get('footer_background'));
...
$body_boxed_background = shortcode_atts(array(
    ...
    'size' => '',
    'color' => ''
), Airi()->settings()->get('body_boxed_background'));

$body_font_size = Airi()->settings()->get('body_font_size', 16);
$body_font_size = str_replace('px', '', $body_font_size);
$body_max_width = Airi()->settings()->get('body_max_width', 1230);
$body_max_width = str_replace('px', '', $body_max_width);
?>
body.airi-body{
    font-size: <?php echo esc_attr($body_font_size) ?>px;
    <?php Airi_Helper::render_background_atts($body_background);?>
}
body.airi-body.body-boxed #page.site{
    ...
    margin-left: auto;
    margin-right: auto;
    <?php Airi_Helper::render_background_atts($body_boxed_background);?>
}
...
.site-header .site-header-inner{
    <?php Airi_Helper::render_background_atts($header_background);?>
}
.enable-header-transparency .site-header:not(.is-sticky) .site-header-inner{
    <?php Airi_Helper::render_background_atts($transparency_header_background);?>
}

.footer-top{
    <?php Airi_Helper::render_background_atts($footer_background);?>
    <?php Airi_Helper::render_canvas_space(Airi()->settings()->get('footer_space'));?>
}
<?php
...
$popup_background =  shortcode_atts(array(
    ...
    'size' => '',
    'color' => ''
), Airi()->settings()->get('popup_background'));

?>
.open-newsletter-popup .lightcase-inlineWrap{
    <?php Airi_Helper::render_background_atts($popup_background);?>
}

<?php if( Airi()->settings()->get('catalog_mode', 'off') == 'on'){
...
<?php
$normal_header_height = str_replace('px', '', Airi()->settings()->get('header_height', 100));
$sticky_header_height = str_replace('px', '', Airi()->settings()->get('header_sticky_height', 80));

$header_sm_height = str_replace('px', '', Airi()->settings()->get('header_sm_height', 100));
$header_sm_sticky_height = str_replace('px', '', Airi()->settings()->get('header_sm_sticky_height', 80));

$header_mb_height = str_replace('px', '', Airi()->settings()->get('header_mb_height', 70));
$header_mb_sticky_height = str_replace('px', '', Airi()->settings()->get('header_mb_sticky_height', 70));


$megamenu_lv1 = str_replace('px', '', Airi()->settings()->get('megamenu_lv1', 16));
$megamenu_lv2 = str_replace('px', '', Airi()->settings()->get('megamenu_lv2', 12));
$megamenu_lv3 = str_replace('px', '', Airi()->settings()->get('megamenu_lv3', 12));
$megamenu_heading = str_replace('px', '', Airi()->settings()->get('megamenu_heading', 13));
...
<?php
$logo_height = str_replace('px', '', Airi()->settings()->get('logo_height', ''));
$logo_mobile_height = str_replace('px', '', Airi()->settings()->get('logo_mobile_height', ''));
?>
