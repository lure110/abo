                ...
                <div class="loop__item__info2">
                    <div class="loop__item__meta loop__item__meta__top"><?php
                        ...
                        if($style == 'echeck'){
                            ...
                            if( ($layout == 'grid' && ($style != 2 && $style != 4 && $style != 5 && $style != 6 && $style != 7)) || ( $layout == 'list' && $style == 1 )){
                                airi_entry_meta_item_postdate();
                                airi_entry_meta_item_author();
                                airi_entry_meta_item_category_list('<div class="loop__item__meta--item loop__item__termlink blog_item--category-link">', '</div>', '');
                            }
                        }
                        if(($layout == 'grid' && ($style == 5 || $style == 6 || $style == 7)) || ($layout == 'list' && $style == 2)){
                    ...
                    if($style == 'echeck'){
                        ...
                        if( ($layout == 'grid' && ($style == 2 || $style == 4 || $style == 5 || $style == 6 || $style == 7)) || ( $layout == 'list' && ($style == 3 || $style == 2)) ){
