	...
	<div class="product_item--inner">
		<div class="product_item--thumbnail">
			<div class="product_item--thumbnail-holder">
				 ...
				 * @hooked Airi_WooCommerce::add_second_thumbnail_to_loop - 15
				 * @hooked Airi_WooCommerce::add_count_up_timer_in_product_listing - 40
				 */
			...
			<div class="product_item_thumbnail_action product_item--action">
				<?php
				/**
				 * airi/action/shop_loop_item_action hook.
				 */
				do_action('airi/action/shop_loop_item_action_top');
				?>
			</div>
		</div>
		<div class="product_item--info">
			<div class="product_item--info-inner">
				 ...
				 * @hooked Airi_WooCommerce::add_count_up_timer_in_product_listing - 7
				 * @hooked woocommerce_template_loop_price - 10
				 * @hooked Airi_WooCommerce::render_attribute_in_list - 10
				 * @hooked Airi_WooCommerce::shop_loop_item_excerpt - 15
				 */
			...
			<div class="product_item--action">
				 ...
				 *
				 */
				do_action('airi/action/shop_loop_item_action');
				?>
			</div>
		</div>
	<?php
