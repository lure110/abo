...
<?php
	...
	$product_cols = shortcode_atts(
		...
		Airi()->settings()->get('crosssell_products_columns')
	);
	...
	$title = Airi()->settings()->get('crosssell_product_title') ? Airi()->settings()->get('crosssell_product_title') : _x( 'You may be interested in&hellip;', 'front-view', 'airi' );
	$sub_title = Airi()->settings()->get('crosssell_product_subtitle') ? Airi()->settings()->get('crosssell_product_subtitle') : '';
