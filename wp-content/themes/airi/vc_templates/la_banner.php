...
if(!empty($title_1)){
    ...
    $__title_1 = explode(' ', esc_html($title_1));
    $__title_1 = array_map(function($str){
...
if(!empty($title_2)){
    ...
    $__title_2 = explode(' ', esc_html($title_2));
    $__title_2 = array_map(function($str){
        return '<span>'. $str . '</span>';
    }, $__title_2);
...
if(!empty($title_3)){
    ...
    $__title_3 = explode(' ', esc_html($title_3));
    $__title_3 = array_map(function($str){
        return '<span>'. $str . '</span>';
    }, $__title_3);
...
<div id="<?php echo esc_attr($unique_id)?>" class="<?php echo esc_attr($css_class);?>">
    <div class="box-inner">
        ...
        airi_deactive_filter( 'jetpack_photon_override_image_downsize', '__return_true' );
        ...
        <div class="banner--info">
            <?php
                echo airi_render_variable($title_1_html . $title_2_html . $title_3_html);
                if($use_link){
                    echo sprintf(
        ...
        <?php
            if( $style == '13' ){
                echo airi_render_variable($title_3_html);
            }
            if($use_link){
                echo sprintf(
    ...
    <?php echo '<style>'; ?>
        ...
        .<?php echo esc_attr($unique_id)?>.la-banner-box .banner--image:after{
            background-color: <?php echo airi_render_variable($overlay_bg_color) ?>;
        }
        <?php endif; ?>
        <?php if(!empty($overlay_hover_bg_color)): ?>
        .<?php echo esc_attr($unique_id)?>.la-banner-box:hover .banner--image:after{
            background-color: <?php echo airi_render_variable($overlay_hover_bg_color) ?>;
        }
        <?php endif; ?>

        <?php if( $style == 1) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-1 .b-title1{
                background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-1 .banner--btn{
                background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>

        <?php if( $style == 2 ) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-2 .b-title1{
                background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-2:hover .b-title1{
                background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>
        ...
        <?php if( $style == 3 ) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-3 .b-title1{
            background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
            color: <?php echo airi_render_variable($btn_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-3:hover .b-title1{
            background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
            color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>
        ...
        <?php if( $style == 7 ) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-7 .banner--btn{
                background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_color) ?>;
            ...
            .<?php echo esc_attr($unique_id)?>.banner-type-7:hover .banner--btn{
                background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>
        ...
        <?php if( $style == 9 ) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-9 .banner--info:after{
                background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-9 .b-title1{
                color: <?php echo airi_render_variable($btn_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-9 .box-inner:hover .banner--info:after{
                background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-9 .box-inner:hover .banner--btn{
                color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>

        <?php if( $style == 10 ) : ?>
            .<?php echo esc_attr($unique_id)?>.banner-type-10 .banner--link-overlay .hidden{
                background-color: <?php echo airi_render_variable($btn_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_color) ?>;
            }
            .<?php echo esc_attr($unique_id)?>.banner-type-10  .banner--link-overlay:hover .hidden{
                background-color: <?php echo airi_render_variable($btn_hover_bg_color) ?>;
                color: <?php echo airi_render_variable($btn_hover_color) ?>;
            }
        <?php endif; ?>
