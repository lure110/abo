(function($) {
    ...
    $(function(){
        ...
        $('input[name="airi_options[enable_header_builder]"]').on('change', function (e) {
            var _val = $(this).val();
            var $nav = $('.la-framework.la-option-framework .la-nav > ul > li:nth-child(3)');
            if(_val == 'yes'){
                $('li:gt(0)', $nav).css('display', 'none');
            }
            else{
                $('li:gt(0)', $nav).show();
            }
        ...
        $(window).on('load', function () {
            var _val = $('input[name="airi_options[enable_header_builder]"]:checked').val();
            var $nav = $('.la-framework.la-option-framework .la-nav > ul > li:nth-child(3)');
            if(_val == 'yes'){
                $('li:gt(0)', $nav).css('display', 'none');
            }
