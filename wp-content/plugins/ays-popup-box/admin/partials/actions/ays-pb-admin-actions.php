...
switch( $action ) {
    case 'add':
        ...
        $loader_iamge = "<span class='display_none'><img width='20' height='20' src=".AYS_PB_ADMIN_URL."/images/loaders/loading.gif></span>";
        break;
    case 'edit':
...
$custom_html        = (isset($popupbox['custom_html']) && $popupbox['custom_html'] != "") ? $popupbox['custom_html'] : "Here can be your custom HTML or Shortcode";
    ...
    <div class="container-fluid">
        <form method="post" name="popup_attributes" id="ays_pb_form">
            ...
            <p class="ays_pb_subtitle">
                <strong class="ays_pb_title_in_top"><?php echo stripslashes(htmlentities($popupbox['title'])); ?></strong>
            </p>
            </div>
            <hr>
            ...
            <div id="tab1" class="ays-pb-tab-content  <?php echo ($ays_pb_tab == 'tab1') ? 'ays-pb-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="<?php echo $this->plugin_name; ?>-popup_title"  class="ays-text-input" name="<?php echo $this->plugin_name; ?>[popup_title]" value="<?php echo stripslashes(htmlentities($popupbox['title'])); ?>" />
                    </div>
                </div>
            ...
            <div id="tab2" class="ays-pb-tab-content  <?php echo ($ays_pb_tab == 'tab2') ? 'ays-pb-tab-content-active' : ''; ?>">
               ...
               <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="<?php echo $this->plugin_name; ?>-scroll_top" name="<?php echo $this->plugin_name; ?>[scroll_top]"  class="ays-text-input-short"  value="<?php echo !isset($popupbox['scroll_top']) ? '' : abs(intval(round($popupbox['scroll_top']))); ?>" step="0.1" />
                    </div>
                </div>
                <hr/>
            ...
            <div id="tab3" class="ays-pb-tab-content  <?php echo ($ays_pb_tab == 'tab3') ? 'ays-pb-tab-content-active' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row pb_theme_img_box">
                                    ...
                                    <div class="pb_theme_image_div col">
                                        <label <?= ( 'minimal' == $view_type) ? 'class="apm_active_theme"' : '' ?>>
                                            <p><?= __('Minimal', $this->plugin_name) ?></p>
                                            <input type="radio" name="<?php echo $this->plugin_name; ?>[view_type]"
                                                   value="minimal" <?= ('minimal' == $view_type) ? 'checked' : '' ?>>
                                            <img src="<?= AYS_PB_ADMIN_URL . '/images/themes/minimal_theme.png' ?>"
                                    ...
                                    <div class='pro_feature_theme'>
                                        <div class="pb_theme_image_div col">
                                            ...
                                            <label <?= ( 'video' == $view_type) ? 'class="apm_active_theme"' : '' ?>>
                                                <p><?= __('Video', $this->plugin_name) ?></p>
                                                <input type="radio" name="<?php echo $this->plugin_name; ?>[view_type]"
                                                    value="video" <?= ('video' == $view_type) ? 'checked' : '' ?>>
                                                <img src="<?= AYS_PB_ADMIN_URL . '/images/themes/video_theme.png' ?>"
                                                    alt="<?= __('Video', $this->plugin_name) ?>">
                                            </label>
                                        </div>
                                        <div class="pb_theme_image_div col">
                                            <div class="pro_features">
                                            ...
                                            <label <?= ( 'peachy' == $view_type) ? 'class="apm_active_theme"' : '' ?>>
                                                <p><?= __('Peachy', $this->plugin_name) ?></p>
                                                <input type="radio" name="<?php echo $this->plugin_name; ?>[view_type]"
                                                    value="peachy" <?= ('peachy' == $view_type) ? 'checked' : '' ?>>
                                                <img src="<?= AYS_PB_ADMIN_URL . '/images/themes/peachy_theme.png' ?>"
                                                    alt="<?= __('Sale', $this->plugin_name) ?>">
                                            </label>
                                        </div>
                                        <div class="pb_theme_image_div col">
                                            ...
                                            <label <?= ( 'yellowish' == $view_type) ? 'class="apm_active_theme"' : '' ?>>
                                                <p><?= __('Yellowish', $this->plugin_name) ?></p>
                                                <input type="radio" name="<?php echo $this->plugin_name; ?>[view_type]"
                                                    value="yellowish" <?= ('yellowish' == $view_type) ? 'checked' : '' ?>>
                                                <img src="<?= AYS_PB_ADMIN_URL . '/images/themes/yellowish_theme.png' ?>"
                                                    alt="<?= __('Sale', $this->plugin_name) ?>">
                                            </label>
                                        </div>
                                        <div class="pb_theme_image_div col">
                                            ...
                                            <label <?= ( 'coral' == $view_type) ? 'class="apm_active_theme"' : '' ?>>
                                                <p><?= __('Coral', $this->plugin_name) ?></p>
                                                <input type="radio" name="<?php echo $this->plugin_name; ?>[view_type]"
                                                    value="coral" <?= ('coral' == $view_type) ? 'checked' : '' ?>>
                                                <img src="<?= AYS_PB_ADMIN_URL . '/images/themes/coral_theme.png' ?>"
                                                    alt="<?= __('Coral', $this->plugin_name) ?>">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="pb_theme_image_div col">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-8" style="<?= $close_btn_style_bg; ?>">
                        ...
                        <div class="popup_preview" >
                            ...
                            <div class='ays-pb-modals'>
                                ...
                                <div class='ays-pb-modal ays-pb-live-container ays_bg_image_box' id="ays-pb-live-container">
                                    ...
                                    <p class="desc" style='<?php echo $hide_desc ;?>'></p>
                                ...
                                <div class='ays-pb-live-container ays_lil_window ays_bg_image_box'>
                                    ...
                                    <div class='ays_lil_content'>
                                        <p class="desc" style='margin: 0; <?php echo $hide_desc ;?>'></p>
                                        <div class="ays_modal_content"><span><?php echo __("Here can be custom HTML or shortcode", $this->plugin_name); ?></span></div>
                                        <?php echo $ays_pb_timer_desc; ?>
                                    </div>
                                </div>
                                ...
                                <div class='ays-pb-live-container ays_minimal_window ays_bg_image_box' id="ays-minimal-window">
                                    <header class='ays_minimal_head'>
                                        <label for='ays-pb-modal-checkbox' class='close_btn_label' style='<?php echo $hide_close_btn; ?>'>
                                                ...
                                                <img class='close-minimal-btn ays-close-button-take-text-color ays-close-button-on-off ays-close-button-text close_btn_img' src='<?php echo $close_btn_background_img; ?>' width='30' height='30' style='<?php echo $close_btn_img_display; ?>' />
                                                <a class='close-image-btn ays-close-button-on-off ays-close-button-text ays-close-button-take-text-color close_btn_text' style='<?php echo $close_btn_text_display;?>'>
                                                     <?php
                                                if ($close_button_text === 'x') {
