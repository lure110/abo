...
<div class="wrap">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL;?>/images/icons/quiz-128x128.png" alt="Quiz Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL; ?>/images/icons/poll-128x128.png" alt="Poll Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL; ?>/images/icons/survey-128x128.png" alt="Survey Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL; ?>/images/icons/pd-logo-128x128.png" alt="Personal Dictionary">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL; ?>/images/icons/icon-gallery-128x128.png" alt="Gallery - Photo Gallery">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo AYS_PB_ADMIN_URL; ?>/images/icons/sccp-128x128.png" alt="Secure Copy Content Protection">
                    <div class="card-body">
