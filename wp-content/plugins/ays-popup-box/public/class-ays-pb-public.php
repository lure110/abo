...
class Ays_Pb_Public {
	...
	public function enqueue_styles() {
		 ...
		 * class.
		 */
        wp_enqueue_style( $this->plugin_name.'-font-awesome', '//use.fontawesome.com/releases/v5.0.13/css/all.css', array(), $this->version, 'all' );
            ...
            $popupbox_view .= "<div id='ays-pb-screen-shade_".$id."' overlay='overlay_".$id."'></div>
                    ...
                    <style>
                        ...
                        .ays-pb-modal_".$id." .ays_content_box p{
                            color: ".$ays_pb_textcolor." !important;
                ...
                if($show_all != 'all'){
                    if($post_id != false){
                        if (!empty($i["view_place"])) {
                            ...
                            $this_post_title = strval(get_post()->ID);
                            $except_posts = array();
