...
class Ays_Pb {
	...
	private function define_admin_hooks() {
        ...
        // Add Reports submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_reports_submenu', 85 );

        // Add Subscribes submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_subscribes_submenu', 86 );
		
		//Add Export/Import submenu
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_export_import_submenu', 85 );

        //Add Settings submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_settings_submenu', 90 );

        //Add How to use submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_how_to_use_submenu', 95 );

        //Add Our Products submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_featured_plugins_submenu', 100 );

        //Add Pro Features submenu
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_plugin_pro_features_submenu', 105 );
		...
		// $this->loader->add_action( 'admin_notices', $plugin_admin, 'ays_pb_sale_baner', 1 );
    }
