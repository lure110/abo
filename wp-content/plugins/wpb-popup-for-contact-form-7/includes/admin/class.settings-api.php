...
if ( !class_exists( 'WPB_PCF_WeDevs_Settings_API' ) ):
class WPB_PCF_WeDevs_Settings_API {
    ...
    function admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'wpb-pcf-settings', plugins_url( 'assets/css/settings.css', __FILE__ ), array(), '1.0' );

        wp_enqueue_media();
        wp_enqueue_script( 'wp-color-picker' );
        wp_enqueue_script( 'jquery' );
        wp_enqueue_script( 'wpb-pcf-settings', plugins_url( 'assets/js/settings.js', __FILE__ ), array( 'jquery' ), '1.0', true );
    }
