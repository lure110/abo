...
class LaStudio_Shortcodes{
    ...
    public function add_login_link( $atts, $content = null ){
        return $this->auto_detect_shortcode_callback( $atts, $content, 'la_login_link');
    }

    public function add_logout_link( $atts, $content = null ){
        return $this->auto_detect_shortcode_callback( $atts, $content, 'la_logout_link');
    }

    public function add_wishlist( $atts, $content = null){
        if(function_exists('wc_print_notices')){
            return $this->auto_detect_shortcode_callback( $atts, $content, 'la_wishlist');
        }
        else{
            return '';
        }
    ...
    public function add_compare( $atts, $content = null){
        if(function_exists('wc_print_notices')) {
            return $this->auto_detect_shortcode_callback($atts, $content, 'la_compare');
        }
        else{
            return '';
        }
