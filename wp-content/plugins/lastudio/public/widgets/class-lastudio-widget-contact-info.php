...
class LaStudio_Widget_Contact_Info extends WP_Widget {
    ...
    public function widget($args, $instance){
        ...
        $workhours = ! empty( $instance['workhours'] ) ? $instance['workhours'] : '';
        ...
        if(!empty($workhours)){
            printf(
                '<div class="la-contact-item la-contact-working-hours"><span>%s</span></div>',
                esc_html($workhours)
            );
        }
        if(!empty($phone)){
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'workhours' ) ); ?>"><?php esc_attr_e( 'Working Hours:', 'lastudio' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'workhours' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'workhours' ) ); ?>" type="text" value="<?php echo esc_attr( $workhours ); ?>">
        </p>
        <p>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['workhours'] = ( ! empty( $new_instance['workhours'] ) ) ? $new_instance['workhours'] : '';
