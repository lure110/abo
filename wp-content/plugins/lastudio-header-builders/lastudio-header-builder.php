...
if ( ! class_exists( 'LaStudio_Header_Builder' ) ) :
    class LaStudio_Header_Builder {
		...
		public function __construct() {
            ...
            add_action( 'after_setup_theme', array( $this, 'auto_register_dynamic_strings') );
        ...
        public function auto_register_dynamic_strings(){
        ...
        private function _html_output( $is_frontend_builder = false, $lahb_data = array(), $include_html_tag = true ){
	        ...
	        LAHB_Helper::set_dynamic_styles('.lahb-icon-content .content_el {display: inline-block;vertical-align: middle;}', true);
					        ...
					        if ( $header_type == 'vertical' && $screen_view_index == 'desktop-view' ) {
						        ...
						        if ($header_type == 'vertical') {
							        ...
							        extract(LAHB_Helper::component_atts(array(
								        ...
								        'vertical_toggle_icon' => 'dl-icon-menu5',
								        'logo' => ''
							        ), $area_settings));
							        ...
							        if(isset($area_settings['height_sae_box'])){
							            unset($area_settings['height_sae_box']);
                                    }
                                    ...
                                    $vbox_width = !empty($area_settings['box_width']) ? $area_settings['box_width'] : '370px';
                                    $vbox_width2 = !empty($area_settings['box_width2']) ? $area_settings['box_width2'] : '270px';
                                    LAHB_Helper::set_dynamic_styles(':root { --vertical-header-width:'.$vbox_width.';--vertical-header-width2:'.$vbox_width2.' }');
